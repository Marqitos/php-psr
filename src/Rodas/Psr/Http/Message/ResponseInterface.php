 ...
 *
 * Based on Http\Message\ResponseInterface.php
...
interface ResponseInterface extends MessageInterface {
     ...
     *
     * @var StatusCode|null Status code.
     */
     ...
     * @link https://tools.ietf.org/html/rfc7231#section-6
     * @link https://www.iana.org/assignments/http-status-codes/http-status-codes.xhtml
     * @param StatusCode|int $code The status result code to set.
     * @param string $reasonPhrase The reason phrase to use with the
     *     provided status code; if none is provided, implementations MAY
     *     use the defaults as suggested in the HTTP specification.
     * @return ResponseInterface
     */
    public function withStatus(StatusCode|int $code, string $reasonPhrase = ''): ResponseInterface;
}
